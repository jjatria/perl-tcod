...
is modified and must be a value in the L<TCOD/BackgroundFlag> enum.
...
method that supports rotation and scaling, see L</blit>.

The value in C<$flags> is one of those in the L<TCOD/BackgroundFlag> enum.
