...
C<$renderer> must be an element of the L<TCOD/Renderer> enum.

=head2 get_renderer

    $renderer = TCOD::Sys::get_renderer;

Get the internal renderer. This will be an element of the L<TCOD/Renderer>
enum.
...
You can get the current screen resolution with L</get_current_resolution>.
...
This function is deprecated. Use SDL2::WaitEvent instead.
